class LikesController < ApplicationController
  before_action :current_user_must_be_like_liker, only: [:edit, :update, :destroy] 
  ...
  def index
    ...
    @likes = @q.result(:distinct => true).includes(:artpiece, :liker).page(params[:page]).per(10)
  end
  ...
  def current_user_must_be_like_liker
    ...
    def like_params
      params.require(:like).permit(:artpiece_id, :liker_id)
    end
end
